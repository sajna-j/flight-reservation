...
# Flights from BOS
flightdata.add_flight(Flight("AA11", "BOS", "DEN", (8, 10), datetime(2024, 11, 1), 20, 180))
flightdata.add_flight(Flight("AA12", "BOS", "JFK", (7, 9), datetime(2024, 11, 2), 25, 120))
flightdata.add_flight(Flight("AA13", "BOS", "LAX", (6, 9), datetime(2024, 11, 3), 30, 300))
flightdata.add_flight(Flight("AA14", "BOS", "ORD", (5, 8), datetime(2024, 11, 4), 20, 180))
flightdata.add_flight(Flight("AA15", "BOS", "DEN", (7, 9), datetime(2024, 11, 6), 30, 180))
flightdata.add_flight(Flight("AA16", "BOS", "JFK", (6, 8), datetime(2024, 11, 5), 25, 120))

#Flights from LAX
flightdata.add_flight(Flight("BB11", "LAX", "ORD", (15, 18), datetime(2024, 11, 1), 20, 180))
flightdata.add_flight(Flight("BB12", "LAX", "BOS", (21, 23), datetime(2024, 11, 2), 25, 300))
flightdata.add_flight(Flight("BB13", "LAX", "DEN", (10, 13), datetime(2024, 11, 3), 30, 180))
flightdata.add_flight(Flight("BB14", "LAX", "BOS", (20, 23), datetime(2024, 11, 4), 20, 300))
flightdata.add_flight(Flight("BB15", "LAX", "BOS", (19, 22), datetime(2024, 11, 5), 25, 300))
flightdata.add_flight(Flight("BB16", "LAX", "ORD", (18, 21), datetime(2024, 11, 6), 30, 180))

# Flights from JFK
flightdata.add_flight(Flight("CC11", "JFK", "BOS", (22, 23), datetime(2024, 11, 1), 20, 60))
...
flightdata.add_flight(Flight("EE12", "ORD", "LAX", (17, 20), datetime(2024, 11, 2), 25, 180))
